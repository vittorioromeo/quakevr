...
using builtin_t = void (*)(); // QSS
using qcvm_t = struct qcvm_s; // QSS

void PR_Init();

void PR_ExecuteProgram(func_t fnum);
void PR_ClearProgs(qcvm_t* vm); // QSS
bool PR_LoadProgs(const char* filename, bool fatal, builtin_t* builtins,
    size_t numbuiltins); // QSS
...
void PR_DumpPlatform_f(); // console command: writes out a qsextensions.qc file
// special hacks...
...
void PR_ClearEngineString(int num); // QSS
