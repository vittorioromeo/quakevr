...
#define MAX_MSGLEN \
    128000 // max length of a reliable message //ericw -- was 32000

#define MAX_DATAGRAM \
    128000 // max length of unreliable message //johnfitz -- was 1024

#define DATAGRAM_MTU \
    2048 // johnfitz -- actual limit for unreliable messages to nonlocal clients
...
#define QVR_VRBITS0_OFFHAND_RELOADFLICKING       VRUTIL_POWER_OF_TWO(10)
#define QVR_VRBITS0_OFFHAND_PREVRELOADFLICKING   VRUTIL_POWER_OF_TWO(11)
#define QVR_VRBITS0_MAINHAND_RELOADFLICKING      VRUTIL_POWER_OF_TWO(12)
#define QVR_VRBITS0_MAINHAND_PREVRELOADFLICKING  VRUTIL_POWER_OF_TWO(13)
