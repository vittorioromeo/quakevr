...
- **The knights' swords** (`progs/v_ksword.mdl`, `v_hksword.mdl`, made by `make_swords.py`) are cut out of Quake VR's
  ...
  [Authentic Model Improvements](https://github.com/NightFright2k19/authmdl) project. Its credits give the knight to
...
- **Bloom's blur:** the 9-tap Gaussian in five linear taps (its weights and offsets) is from Daniel R�kos,
